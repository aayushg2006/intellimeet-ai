        ...
        <div className="w-full max-w-sm">
          <div className="rounded-[28px] border border-white/20 bg-white/10 p-6 shadow-[0_20px_80px_rgba(2,6,23,0.35)] backdrop-blur-lg sm:p-7">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <label className="flex items-center text-sm">
                ...
                <span className="ml-2 text-purple-100">
                  I agree to the{' '}
                  <a href="#" className="font-medium text-purple-300 transition hover:text-white">
                    Terms & Conditions
                  </a>
                </span>
              </label>
            ...
            <p className="mt-6 text-center text-sm text-purple-100/80">
              ...
              <Link to="/login" className="font-medium text-purple-300 transition hover:text-white">
                Sign in here
              </Link>
            </p>
          </div>
